...
public class VibratorStrengthPreference extends Preference implements
	...
	private void setValue(String newValue, boolean withFeedback) {
        ...
        editor.putString(RealmeParts.KEY_VIBSTRENGTH, newValue);
        editor.commit();
        if (withFeedback) {
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(RealmeParts.KEY_VIBSTRENGTH, "3596");
