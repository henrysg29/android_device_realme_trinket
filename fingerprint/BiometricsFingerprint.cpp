 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.oppo_r5x"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.oppo_r5x"
